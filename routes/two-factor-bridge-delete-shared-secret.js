...
router.get('/two-factor-bridge-delete-shared-secret', ensureAuthenticated, function(req, res){
    var response = res;
    TwoFactorAuthenticator.deleteSharedSecret(req.user.email, req.query.code, function(err, res){
        if (err) {

...
ViewProducts.prototype.getHtmlForProductInModalList = function(key, object){
    ...
    html +=         '<b class="fn-order-total" value="'+key+'">0.00000000 BTC</b>';
    html +=     '</div>';
    html +=     '<div class="css-dillon-gage-amount-modal">';
    html +=         '<b class="fn-order-qty" value="'+key+'">0</b>';
    html +=     '</div>';
    html +=     '<div class="css-dillon-gage-product-price-modal">';
    html +=         '<b class="fn-order-unit-price" value="'+key+'">0.00000000 BTC</b>';
    html +=     '</div>';
    html += '</div>';
    return html;
}
